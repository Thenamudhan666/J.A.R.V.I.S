...
export const HolographicOrb: React.FC<HolographicOrbProps> = ({
  ...
  useEffect(() => {
    ...
    const animate = () => {
      ...
      let speedMult = 1.0;
      let displacementFactor = 0.15 + currentAmp * 0.4;
      ...
      if (isInterrupted) {
        ...
        switch (currentState) {
          ...
          case 'listening':
            ...
            coreColor = 0x10b981;
            speedMult = 1.4;
            displacementFactor = 0.2 + currentAmp * 0.6;
            break;
          case 'debating':
            // Electric Violet
            targetR = 0.75;
  ...
  return (
    <div id="holographic-orb-container" className="relative flex flex-col items-center justify-center p-4 bg-[#000] border border-[#333] overflow-hidden min-h-[360px] flex-1">
      ...
      <div ref={mountRef} className="w-full h-64 sm:h-72 max-w-[320px] max-h-[320px] relative z-10 cursor-pointer" />
