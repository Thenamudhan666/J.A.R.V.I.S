...
export default function App() {
  ...
  return (
    <div className="h-full flex flex-col font-sans">
      ...
      <header
        id="app-header-bar"
        className="flex justify-between items-end border-b border-slate-800 px-6 pb-4 pt-6 bg-slate-950 sticky top-0 z-50"
      >
        <div>
      ...
      {/* Main App Body */}
      <main className="flex-1 w-full mx-auto p-4 sm:p-6 flex flex-col min-h-0 overflow-y-auto bg-slate-950 gap-6">
        ...
        {activeTab === 'cockpit' && (
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
            ...
            <div className="lg:col-span-7 flex flex-col bg-slate-900/80 border border-slate-800 rounded-2xl p-5 shadow-xl backdrop-blur-xl min-h-[560px]">
